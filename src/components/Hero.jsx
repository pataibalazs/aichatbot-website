      ...
      <div className="mx-auto max-w-7xl px-6 pb-24 sm:pb-32 lg:flex lg:px-8 lg:py-20 gap-10 z-30">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
          ...
          <div className="mt-10 flex items-center gap-x-6">
            <a
              href="#"
              className="rounded-2xl bg-pageColors-4 px-8 py-3 text-2xl font-semibold text-pageColors-1 shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              Start now!
            </a>
          </div>
